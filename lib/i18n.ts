...
const dictionaries = {
  ...
  he: {
    common: {
      ...
      founderAnalyticsCopy:
        "אנליטיקה ברורה למייסדים ולמפעילים סביב רווחיות, ריטנשן והחלטות תפעול שבועיות.",
      shellHeroCopy:
        "בהירות ברווחיות, שיפור בריטנשן ודיווח שבועי שמוביל לפעולה."
    },
    nav: {
      overview: "סקירה",
      profit: "רווחיות",
    ...
    overview: {
      ...
      description:
        "תמונה אחת שמסבירה מה השתנה, למה זה חשוב, ואיפה צריך לשים לב לרווחיות ולריטנשן.",
    ...
    profit: {
      ...
      salesByProductDescription: "ה־SKU המובילים לפי תרומת הכנסות.",
    ...
    retention: {
      ...
      description:
        "שכבת הריטנשן בנויה סביב הזמנה ראשונה, הזמנה שנייה ולקוחות חוזרים, כדי להפוך את המוצר לכלי תפעולי אמיתי ולא רק וידג'ט שטחי של רכישה חוזרת.",
    ...
    weeklySummary: {
      ...
      generationTodo:
        "TODO: להחליף את הסיכומים המדומים ביצירת סיכום AI שמבוססת על דלתאות אמיתיות, רווחיות וריטנשן.",
    ...
    alertsPage: {
      ...
      description:
        "ההתראות עדיין מבוססות חוקים פשוטים, אבל המבנה כבר מוכן למנוע כללים שיזהה עלייה בהנחות, ירידה בריטנשן, לחץ מהחזרים וצמיחה חריגה.",
    ...
    creator: {
      ...
      connectInstagram: "????? ?? ????",
      connectInstagramOauth: "????? ?? Instagram",
      connecting: "מתחבר...",
