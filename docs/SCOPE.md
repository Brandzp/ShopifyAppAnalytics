...
| `app/creator-flow` | **experimental** | Creator onboarding / content flow. Pairs with creator services. |
...
| `build_out.log`, `dev-server.log` | **deprecated** | Build/dev logs committed to repo; should be gitignored. |
